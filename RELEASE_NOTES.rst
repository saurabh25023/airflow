...
This new feature will add richer data for users to use OpenTelemetry standard to emitt and send their trace data to OTLP compatible endpoints.
...
New Features
""""""""""""
- AIP-61 Hybrid Execution (`AIP-61 <https://github.com/apache/airflow/pulls?q=is%3Apr+is%3Amerged+label%3AAIP-61+milestone%3A%22Airflow+2.10.0%22>`_)
...
- AIP-49 OpenTelemetry support (`AIP-49 <https://github.com/apache/airflow/pulls?q=is%3Apr+is%3Amerged+label%3AAIP-49+milestone%3A%22Airflow+2.10.0%22>`_)
...
- Support LazySelectSequence in serialization for AIP-44 (#40779)
...
- Improve handling for params serialization for AIP-44 (#40772)
